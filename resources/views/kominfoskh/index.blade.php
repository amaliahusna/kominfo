    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <table class="col-6">
                ...
                <button type="button" class="col-sm4 btn btn-primary my-2 my-sm-0 floatright" data-toggle="modal"
                ...
                <form class="form-inline my-2 my-lg-0" method="GET" action="/kominfoskh">
                    ...
                    <button type="submit" class="btn btn-outline-secondary my-2 row-col-md-4">Cari</button>
                </form>
        </div>
