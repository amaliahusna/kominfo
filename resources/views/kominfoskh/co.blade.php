        ...
        <div class="row">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>{{$kominfoskh->Foto}}</td>
                    <td><a href="/kominfoskh/{{$kominfoskh->id}}/edit" class = "btn btn-warning bgn-sm">Edit</a></td>
                    <td><a href="/kominfoskh/delete/{{$kominfoskh->id}}" class = "btn btn-danger bgn-sm" onclick="return confirm ('Yakin Dihapus?')">Delete</a></td>
                </tr>
                @endforeach
            </table>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/kominfoskh/create" method="POST">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                            ...
                            <input name="Ruang" type="text" class="form-control" id="Ruang"
                                aria-describedby="EmailHelp" placeholder="Ruang">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Bukti</label>
                            <input name="Foto" type="file" class="form-control" id="Foto"
                                aria-describedby="EmailHelp" placeholder="Foto">
                        </div>
                </div>
